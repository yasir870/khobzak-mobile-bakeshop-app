-- Fix data type inconsistencies and security issues
...
-- Fix customers table policies - remove self-referential issue
...
-- Fix drivers table policies - remove self-referential issue  
