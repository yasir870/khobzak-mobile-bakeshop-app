    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-muted flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-0">
          ...
          <CardTitle className="text-2xl text-card-foreground">{t('chooseYourRole')}</CardTitle>
          ...
          <CardContent className="space-y-4">
            <Button
              ...
              className="w-full h-16 font-semibold text-lg shadow-lg transition-all duration-200 hover:shadow-xl hover:scale-[1.02]"
              size="lg"
            >
