              ...
              <Card key={order.id} className="bg-white/90 backdrop-blur-sm border border-amber-200">
                ...
                <CardContent className="pt-0">
                  <div className="space-y-3">
                    {/* Order Items */}
                    <div>
                      <h4 className="font-medium text-amber-800 mb-2">{t('items') || 'Items'}:</h4>
                    ...
                    {/* Address */}
                    <div>
                      <span className="font-medium text-amber-800 text-sm">{t('address') || 'Address'}:</span>
                    ...
                    {order.notes && (
                      <div>
                        <span className="font-medium text-amber-800 text-sm">{t('notes') || 'Notes'}:</span>
